...
int main(int argc, string argv[])
{
    ...
    {
        // ranks[i] is voter's ith preferencel
...
bool vote(int rank, string name, int ranks[])
{
    ...
    {
        if (strcmp(name, candidates[i]) == 0) break;
    }
...
void record_preferences(int ranks[])
{
    for (int i = 0; i < candidate_count; i++)
    {
        ...
        {
                // The idea on putting rank[j] in the second subscript I found with someone in reddit.
